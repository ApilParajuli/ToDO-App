...
import com.example.android.todo_list.Screens.Dao.NoteDao_Impl;
    ...
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      protected void validateMigration(SupportSQLiteDatabase _db) {
        ...
        if (! _infoNoteTable.equals(_existingNoteTable)) {
          throw new IllegalStateException("Migration didn't properly handle note_table(com.example.android.todo_list.Screens.Entity.Note).\n"
                  + " Expected:\n" + _infoNoteTable + "\n"
                  + " Found:\n" + _existingNoteTable);
        }
      }
